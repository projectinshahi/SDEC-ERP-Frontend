    ...
    permissions: [
      {
        key: 'notice.view',
        label: 'View Notice',
        description: 'See the standalone Notice module in the sidebar and open the Notice dashboard',
        module: 'notice',
      },
      {
        key: 'notice.create',
        label: 'Publish Notice',
        description: 'Create and publish company notices',
        module: 'notice',
      },
      {
        key: 'notice.manage',
        label: 'Manage Notices',
        description: 'Edit, pin and delete any notice',
        module: 'notice',
      },
      {
        key: 'notice.categories.manage',
        label: 'Manage Notice Categories',
        description: 'Add, rename, recolor, reorder and disable notice categories',
        module: 'notice',
      },
    ],
  },

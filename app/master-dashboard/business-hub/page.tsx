  ...
  const workspaces = [
    {
      ...
      icon: Briefcase, color: 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400',
    ...
    },
    {
      ...
      icon: Target, color: 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400',
    ...
    },
    {
      ...
      icon: AlertTriangle, color: 'bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400',
    ...
    },
    {
      ...
      icon: CalendarDays, color: 'bg-violet-50 dark:bg-violet-900/20 text-violet-600 dark:text-violet-400',
    ...
    },
    {
      ...
      icon: Bug, color: 'bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400',
    ...
    },
    {
      ...
      icon: LayoutGrid, color: 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400',
              ...
              <Card className="h-full p-6 border-slate-200 dark:border-slate-800 shadow-sm rounded-2xl hover:border-amber-300 dark:hover:border-amber-700/50 hover:shadow-md transition-all flex flex-col justify-between">
                <div>
                  <div className="flex items-start justify-between mb-4">
                    <div className={classNames('w-14 h-14 rounded-2xl flex items-center justify-center transition-transform group-hover:scale-110', ws.color)}>
                      <ws.icon size={28} />
                    </div>
                ...
                <div className="mt-5 pt-4 border-t border-slate-100 dark:border-slate-800 flex items-baseline justify-between">
                  <span className="text-2xl font-extrabold text-slate-900 dark:text-white tabular-nums">{ws.metric}</span>

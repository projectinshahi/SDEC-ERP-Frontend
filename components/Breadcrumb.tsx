...
export const Breadcrumb = ({ items }: BreadcrumbProps) => {
  ...
  // module. Resolved from the route via moduleForPath — breadcrumbs only render on
  // module pages (never the shared My Tasks/Notice workspaces), so the path alone is
  // always the right module and no `?module=` query context is needed here.

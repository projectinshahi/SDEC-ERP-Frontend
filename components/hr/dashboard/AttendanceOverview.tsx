          ...
          <>
            ...
            <div className="relative w-40 h-40 shrink-0">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-2xl font-black text-gray-900 dark:text-white tabular-nums leading-none">{total}</span>
            ...
            <div className="w-full grid grid-cols-2 gap-2">
              {chartData.map((item) => {
                ...
                return (
                  <div
                    key={item.name}
                    className="flex items-center justify-between rounded-xl border border-gray-100 dark:border-gray-800 px-3 py-2 bg-gray-50/60 dark:bg-gray-800/20"
                  >
                    ...
                    <div className="text-right ml-2 shrink-0">
                      <span className="text-xs font-black text-gray-800 dark:text-gray-200 tabular-nums">{item.value}</span>
                      <span className="text-[10px] text-gray-400 dark:text-gray-600 block">{pct}%</span>
                    </div>
                  </div>
                );
              })}

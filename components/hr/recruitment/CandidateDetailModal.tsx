  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6" role="dialog" aria-modal="true">
      ...
      <div className="relative z-10 w-full max-w-md bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-850 flex flex-col max-h-[85vh] overflow-hidden">
        ...
        {/* Header Banner */}
        <div className="bg-blue-600 dark:bg-gray-800 px-6 py-6 text-white shrink-0 relative">
          <button 
            onClick={onClose}
        ...
        <div className="overflow-y-auto flex-1 p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4 bg-gray-50 dark:bg-gray-800/20 p-4 rounded-xl border border-gray-100 dark:border-gray-850/40">
            {/* Email */}
            <div className="space-y-1">
              ...
              {candidate.email ? (
                <a 
                  ...
                  className="inline-flex items-center gap-1 text-xs font-semibold text-gray-800 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:underline"
                >
          ...
          <div className="space-y-3.5">
            {detailRows.map((row) => {
              const Icon = row.icon;
              return (
                <div key={row.label} className="flex items-center justify-between border-b border-gray-100 dark:border-gray-850/50 pb-2">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3.5 bg-gray-50 dark:bg-gray-800/20 border border-gray-100 dark:border-gray-850/40 rounded-xl">
          ...
          <div className="space-y-2 pt-2 shrink-0">
            ...
            {candidate.resumeUrl ? (
              ...
              <div className="p-3.5 border border-dashed border-gray-200 dark:border-gray-850 rounded-xl text-center">
        ...
        {/* Footer Actions */}
        <div className="px-6 py-4 border-t border-gray-100 dark:border-gray-850/80 bg-gray-50/50 dark:bg-gray-900 shrink-0 flex justify-end">
          <button
            onClick={onClose}

                      ...
                      return (
                        <div key={att.id} className="flex flex-col border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm hover:shadow transition-shadow">
                          ...
                          <div className="p-2 border-t border-gray-100 flex flex-col justify-between flex-1">
                            <div>
                              <p className="text-xs font-semibold text-gray-700 truncate" title={att.file_name}>{att.file_name}</p>
                              {att.description && (
                            ...
                            <p className="text-[10px] text-gray-500 mt-1.5">{(att.file_size / 1024).toFixed(1)} KB • {att.uploader?.name}</p>
                          </div>
                        </div>
                      );
                    })}

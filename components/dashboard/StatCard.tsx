...
export function StatCard({
  ...
  return (
    <Card variant="outlined" className="h-full transition-all duration-200 hover:shadow-md !bg-white !border-gray-200">
      <CardBody className="p-6">
        <div className="flex items-center justify-between h-full">
          
          {/* Main textual metrics panel */}
          <div className="flex-1 min-w-0 pr-4">
            <p className="text-sm font-semibold tracking-wide text-gray-500 whitespace-normal mb-1">
              {label}
            </p>
            ...
            {isError ? (
              <div className="space-y-2">
                ...
                {onRetry && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-[11px] font-bold text-indigo-600 hover:text-indigo-500 hover:underline focus:outline-none transition-colors"
                  >
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] text-gray-400">Wait for next sync</p>
              </div>
            ) : (
              /* 4. Normal Presentation State */
              <>
                <p className="text-2xl font-extrabold tracking-tight text-gray-900 leading-tight">
                  {value}
                </p>
